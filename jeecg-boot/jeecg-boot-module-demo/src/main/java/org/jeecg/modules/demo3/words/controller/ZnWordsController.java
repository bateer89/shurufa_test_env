...
public class ZnWordsController extends JeecgController<ZnWords, IZnWordsService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "汉字对照表-分页列表查询")
	@ApiOperation(value="汉字对照表-分页列表查询", notes="汉字对照表-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "汉字对照表-添加")
	@ApiOperation(value="汉字对照表-添加", notes="汉字对照表-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "汉字对照表-编辑")
	@ApiOperation(value="汉字对照表-编辑", notes="汉字对照表-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "汉字对照表-通过id删除")
	@ApiOperation(value="汉字对照表-通过id删除", notes="汉字对照表-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "汉字对照表-批量删除")
	@ApiOperation(value="汉字对照表-批量删除", notes="汉字对照表-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "汉字对照表-通过id查询")
	@ApiOperation(value="汉字对照表-通过id查询", notes="汉字对照表-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, ZnWords znWords) {
        return super.exportXls(request, znWords, ZnWords.class, "汉字对照表");
    }
